...
<%
	...
	BoardVo row = brddao.getBoardByNo(no);
%>
	<div class="jb=box">
		<div class="jb-text">
	...
	<div class="content_wrapper">
				...
				<div class="iboard-document-wrap">
					...
					<div class="iboard-detail">
						<div class="detail-attr detail-writer">
							...
							<div class="detail-value"><%=row.getWrite_name() %></div>
						</div>
						<div class="detail-attr detail-date">
							<div class="detail-name">작성일</div>
							<div class="detail-value"><%=row.getRegdate() %></div>
						</div>
						<div class="detail-attr detail-view">
							<div class="detail-name">조회수</div>
							<div class="detail-value"><%=row.getViews() %></div>
						</div>
					</div>
					
					<div id="iboard-content">
						<div class="content-view">
						<%= row.getContents() %><br>
						<br>
						"코로나 백신 개발 3차 임상 실험 완료 하였습니다."<br>
						<br>
						연구원 : 이승우, 김건우, 송길수, 정석현<br>
					</div>
					
					<!-- 이전 또는 다음 게시물 -->
					<div class="iboard-document-action">
						<div class="left">
						<button>이전</button></div>
						
						<div class="right">
						<button>다음</button></div>
					</div>
		...
		<div class="iboard-list-header">
			...
			<div class="iboard-search">
				<form id="ibaord-search-form-1" method="GET" action="noticelist.jsp">
					<select name="target">
					...
					<button type="submit" class="iboard-default-button-small" onclick="search();">검색</button>
				</form>
			</div>
