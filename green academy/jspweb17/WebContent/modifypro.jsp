...
<%
	...
	if(session.getAttribute("userid")==null) { // 세션이 없다면
		out.println("<script>alert('로그인되지 않았습니다'); location.href='exam2.jsp'</script>");
	}else{  // 세션이 있다면 회원정보 가져오기
		id = (String)session.getAttribute("userid"); // 로그인 아이디
		

		String saveDir = "C:\\workspace\\jspweb17\\WebContent\\upload";
		...
		String phn = multi.getParameter("phone");
