...
public class Product {
	...
	public void buy(int kind) {
		...
		case 1:
			if(compute(RED)==true) {
				System.out.println("1번 새콤달콤 딸기맛 아이스크림~");
			}break;
		case 2:
			if(compute(YELLOW)==true) {
				System.out.println("2번 바닐라맛 아이스크림입니다!");
			}break;
		case 3:
			if(compute(BROWN)==true) {
				System.out.println("3번 초코쿠키가 듬뿍 들어간 초코맛 아이스크림 야미~");
			}break;
		case 4:
			if(compute(VIOLET)==true) {
				System.out.println("4번 몸에 좋은 블루베리 있는 아이스크림이 쏙~");
			}break;
		default:
