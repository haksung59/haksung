...
//            it.background = ContextCompat.getDrawable(this, R.drawable.arrows)
            it.background = ResourcesCompat.getDrawable(resources, R.drawable.arrows, this.theme)
        }

        findViewById<ImageView>(R.id.image).setOnClickListener {
            (it as ImageView).setImageDrawable(resources.getDrawable(R.drawable.logo_fb,this.theme))
        }
