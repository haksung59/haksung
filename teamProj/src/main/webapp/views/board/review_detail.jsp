...
<div class="content_wrapper">
		...
		<h3>${mainData.title }</h3>
			<table class="boarddetail">
				...
				<tr>
					...
					<a id="edit" href="review_modifyForm?no=${mainData.no }">수정</a>
					</td>
				</tr>
			</table>
		</div>
		...
		<div class="commentform" id="commentForm">
		    <form name="commentInsertForm">
		        ...
		        작성자: <input type="text" id="writer" name="writer" size="20" maxlength="20" value="${userdata.name}" readonly/><br/>
		        <textarea id="content" name="content" rows="3" cols="100" maxlength="500" placeholder="댓글을 달아주세요."></textarea>
...
function hide(){
	...
	var kinds = '${userdata.name}'
	
	comment.style.display='none';
	del.style.display='none';
	edit.style.display='none';

if(kinds == '${mainData.category}'){
		del.style.display='none';
		edit.style.display='none';
