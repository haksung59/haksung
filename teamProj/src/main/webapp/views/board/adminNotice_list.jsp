...
<div class="content_wrapper">
	...
	<div id="contents">
	<h1>관리자 공지사항</h1><br>
	<h3>총 관리자가 공지합니다. 지점관리자는 꼭 읽어주세요</h3>
	...
	<c:forEach items="${mainData }" var="vo" varStatus="no">
		<tr>
			...
			<td class="title"><a href="adminNotice_detail?no=${vo.no }">${vo.title }</a></td>
			<td>${vo.pname }</td>
	...
	<tr>
		...
		<tr>
			<td colspan="5" align="right">
				<a id="write" href="adminNotice_writeForm">글쓰기</a>
			</td>
		</tr>
	</table>
	</div>
