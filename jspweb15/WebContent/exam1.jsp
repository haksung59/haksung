...
<body>
	...
	<%
		...
		String designation = "255";
		String phone = "010-4444-3333";
		
		String sql = String.format("insert into emp value ('%s', '%s', '%s', '%s', '%s')",
															id, name, passwd, designation, phone);	//결과 3
		...
		try {
			...
			//stmt = conn.createStatement();
			int result = stmt.executeUpdate(sql);	//insert update delete + 자동커밋됨.
